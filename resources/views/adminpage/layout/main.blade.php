...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('adminpage/img/favicon.png') }}" rel="icon">
    <link href="{{ asset('adminpage/img/apple-touch-icon.png') }}" rel="apple-touch-icon">
    ...
    <link href="{{ asset('adminpage/vendor/bootstrap-icons/bootstrap-icons.css') }}" rel="stylesheet">
    <link href="{{ asset('adminpage/vendor/boxicons/css/boxicons.min.css') }}" rel="stylesheet">
    <link href="{{ asset('adminpage/vendor/quill/quill.snow.css') }}" rel="stylesheet">
...
<body>
    ...
    @include('adminpage.partials.header-sidebar')
    ...
    <!-- Vendor JS Files -->
    <script src="{{ asset('adminpage/vendor/apexcharts/apexcharts.min.js') }}"></script>
    <script src="{{ asset('adminpage/vendor/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('adminpage/vendor/chart.js/chart.umd.js') }}"></script>
    <script src="{{ asset('adminpage/vendor/echarts/echarts.min.js') }}"></script>
    <script src="{{ asset('adminpage/vendor/quill/quill.min.js') }}"></script>
